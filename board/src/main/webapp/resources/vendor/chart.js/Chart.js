...
module.exports = {
	...
	modes: {
		...
		/**
		 * Point mode returns all elements that hit board based on the event position
		 * of the event
		...
		/**
		 * x mode returns the elements that hit-board at the current x coordinate
		...
		/**
		 * y mode returns the elements that hit-board at the current y coordinate
...
var helpers = {
	 ...
	 * @param {*} value - The value to board.
	 * @returns {Boolean}
	 * @since 2.7.0
	 */
