...
<head>
	...
	<link type="text/css" rel="stylesheet" href="<%=contextPath%>/resources/bootstrap/css/bootstrap.min.css" />
	<link href="<%=contextPath%>/resources/bootstrap/css/starter-template.css" rel="stylesheet">

	<script src="http://code.jquery.com/jquery-2.1.1.min.js" type="text/javascript"></script>
	<script type="text/javascript" src="<%=contextPath%>/resources/js/base.js" ></script>
	<script type="text/javascript" src="<%=contextPath%>/resources/bootstrap/js/bootstrap.min.js" ></script>

	<script src="<%=contextPath%>/resources/bootstrap/js/ie-emulation-modes-warning.js"></script>
